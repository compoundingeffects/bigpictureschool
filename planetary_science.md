...
Once a planet has an atmosphere, physics takes over to create weather. The Sun heats the atmosphere unevenly — different parts of the planet receive different amounts of sunlight depending on their angle to the Sun — and the planet's rotation causes the resulting winds to curve. This is known as the Coriolis effect, and it's why hurricanes spin counterclockwise in the Northern Hemisphere. Certain gases in the atmosphere also trap heat near the surface, the same way a blanket traps heat around your body — this is the greenhouse effect. Together, these processes drive weather systems and long-term climate patterns that can completely transform a planet's surface over millions of years.
